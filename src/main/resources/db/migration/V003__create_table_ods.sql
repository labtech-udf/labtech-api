...
-- INSERT INTO eventos.ods_tb (created_by, updated_by, excluded, name, description, status)  -- Update "name" to the actual column name (e.g., "nome")
INSERT INTO eventos.ods_tb (id, created_by, updated_by, excluded, name, description, status)
SELECT *
FROM (VALUES (1, 'admin', 'admin', FALSE, 'Erradicação da Pobreza',
             ...
             (17, 'admin', 'admin', FALSE, 'Parcerias para as Metas',
              ...
              TRUE)) AS t (id, created_by, updated_by, excluded, name, description, status)
